...
public class RatingService {
     ...
     *
     * <p>
     * This method verifies that the caller exists, is permitted to
     ...
     * recalculated and a response is returned.
     * </p>
     *
     * @param taskId   the identifier of the task being rated
     * @param callerId the identifier of the authenticated user submitting the
     *                 rating
     ...
     *                                 the caller is not authorised, the task is not
     *                                 eligible
    ...
    public RatingResponse submitRating(int taskId, int callerId, RatingRequest request) {
        ...
        ratingRepository.recalculateAverageRating(helperId, request.getRating());
